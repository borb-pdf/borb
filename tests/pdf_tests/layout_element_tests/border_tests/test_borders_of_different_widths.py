...
class TestBordersOfDifferentWidths(unittest.TestCase):
    ...
    def test_borders_of_different_widths_no_background(self):
        ...
        PDF.write(what=d, where_to="assets/test_borders_of_different_widths_no_background.pdf")
    ...
    def test_borders_of_different_widths_with_background(self):
        ...
        PDF.write(what=d, where_to="assets/test_borders_of_different_widths_with_background.pdf")

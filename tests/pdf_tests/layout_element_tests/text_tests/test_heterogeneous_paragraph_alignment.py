...
class TestHeterogeneousParagraphAlignment(TestCase):
    ...
    def test_heterogeneous_paragraph_alignment_left_top(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_left_top.pdf",
        )
    ...
    def test_heterogeneous_paragraph_alignment_left_middle(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_left_middle.pdf",
        )
    ...
    def test_heterogeneous_paragraph_alignment_left_bottom(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_left_bottom.pdf",
        )
    ...
    def test_heterogeneous_paragraph_alignment_middle_top(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_middle_top.pdf",
        )
    ...
    def test_heterogeneous_paragraph_alignment_middle_middle(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_middle_middle.pdf",
        )
    ...
    def test_heterogeneous_paragraph_alignment_middle_bottom(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_middle_bottom.pdf",
        )
    ...
    def test_heterogeneous_paragraph_alignment_right_top(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_right_top.pdf",
        )
    ...
    def test_heterogeneous_paragraph_alignment_right_middle(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_right_middle.pdf",
        )
    ...
    def test_heterogeneous_paragraph_alignment_right_bottom(self):
        ...
        TestCase.write(
            what=d,
            where_to=f"test_heterogeneous_paragraph_alignment_right_bottom.pdf",
        )

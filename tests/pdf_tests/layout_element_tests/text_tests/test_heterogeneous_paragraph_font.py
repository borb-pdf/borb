...
class TestHeterogeneousParagraphFont(TestCase):

    def test_heterogeneous_paragraph_font(self):
        d: Document = Document()
        ...
        TestCase.write(what=d, where_to="test_heterogeneous_paragraph_font.pdf")

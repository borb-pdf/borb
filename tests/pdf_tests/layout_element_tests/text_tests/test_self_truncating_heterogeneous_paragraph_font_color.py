...
class TestSelfTruncatingHeterogeneousParagraphFontColor(TestCase):

    def test_self_truncating_heterogeneous_paragraph_font_color(self):
        d: Document = Document()
        ...
        TestCase.write(
            what=d,
            where_to="test_self_truncating_heterogeneous_paragraph_font_color.pdf",
        )

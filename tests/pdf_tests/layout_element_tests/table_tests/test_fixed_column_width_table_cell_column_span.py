...
class TestFixedColumnWidthTableCellColumnSpan(TestCase):

    def test_fixed_column_width_table_cell_column_span(self):
        d: Document = Document()
        ...
        TestCase.write(
            what=d, where_to="test_fixed_column_width_table_cell_column_span.pdf"
        )

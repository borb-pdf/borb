...
class TestFixedColumnWidthTableNoExternalBorders(TestCase):

    def test_fixed_column_width_table_no_external_borders(self):
        d: Document = Document()
        ...
        TestCase.write(
            what=d,
            where_to="test_fixed_column_width_table_no_external_borders.pdf",
        )

...
class TestFlexibleColumnWidthTableCellColumnSpan(TestCase):

    def test_flexible_column_width_table_cell_column_span(self):
        d: Document = Document()
        ...
        TestCase.write(
            what=d,
            where_to="test_flexible_column_width_table_cell_column_span.pdf",
        )

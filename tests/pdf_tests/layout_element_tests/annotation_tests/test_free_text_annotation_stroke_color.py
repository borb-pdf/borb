...
class TestFreeTextAnnotationBackground(TestCase):

    def test_free_text_annotation_background(self):
        d: Document = Document()
        ...
        TestCase.write(what=d, where_to="test_free_text_annotation_background.pdf")

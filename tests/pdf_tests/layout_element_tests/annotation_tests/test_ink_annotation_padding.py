...
class TestInkAnnotationPadding(TestCase):
    ...
    def test_ink_annotation_padding_left(self):
        ...
        TestCase.write(what=d, where_to="test_ink_annotation_padding_left.pdf")
    ...
    def test_ink_annotation_padding_top(self):
        ...
        TestCase.write(what=d, where_to="test_ink_annotation_padding_top.pdf")
    ...
    def test_ink_annotation_padding_right(self):
        ...
        TestCase.write(what=d, where_to="test_ink_annotation_padding_right.pdf")
    ...
    def test_ink_annotation_padding_bottom(self):
        ...
        TestCase.write(what=d, where_to="test_ink_annotation_padding_bottom.pdf")

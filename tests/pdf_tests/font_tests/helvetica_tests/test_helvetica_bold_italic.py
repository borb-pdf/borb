...
class TestHelveticaBoldItalic(TestCase):
    ...
    def test_helvetica_bold_italic(self):
        ...
        # font
        font: Font = Standard14Fonts.get("Helvetica Bold Italic")
        # useful constant(s)
        ...
        TestCase.write(what=d, where_to="test_helvetica_bold_italic.pdf")

...
class TestTimesBoldItalic(TestCase):

    def test_times_bold_italic(self):
        d: Document = Document()
        ...
        # font
        font: Font = Standard14Fonts.get("Times Bold Italic")
        # useful constant(s)
        ...
        TestCase.write(what=d, where_to="test_times_bold_italic.pdf")

...
class TestCourierItalic(TestCase):

    def test_courier_italic(self):
        d: Document = Document()
        ...
        # font
        font: Font = Standard14Fonts.get("Courier Italic")
        # useful constant(s)
        ...
        TestCase.write(what=d, where_to="test_courier_italic.pdf")
